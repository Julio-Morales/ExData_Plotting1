...
# Plot 1. Histogram
#
# Require histogram plots Global Active Power 
# 
...
hist(as.numeric(filterdf$Global_active_power),col="red",xlab="Global Active Power (kilowatts)",ylab="Frequency",main="Global Active Power")
dev.off()
